...
const HOTKEY_LABELS: Record<string, TKey> = {
  attackMove: 'attackMove', stop: 'stop', hold: 'hold', patrol: 'patrol', buildMenu: 'build', castle: 'castle', house: 'house', barracks: 'barracks', forge: 'forge', tower: 'tower', wall: 'wall', goldMine: 'goldMine', eject: 'eject',
