...
const HOTKEY_LABELS: Record<string, TKey> = {
  attackMove: 'attackMove', stop: 'stop', hold: 'hold', patrol: 'patrol', buildMenu: 'build', castle: 'castle', house: 'house', barracks: 'barracks', forge: 'forge', tower: 'tower', wall: 'wall', goldMine: 'goldMine', eject: 'eject', cavalry: 'cavalry', dismantle: 'dismantle', ageUp: 'ageUp',
      ...
      <div className="card">
        ...
        <table className="settings">
          <tbody>
            ...
            <tr><td>{t('touchControls')}</td><td><select value={s.touchUI} onChange={(e) => updateSettings({ touchUI: e.target.value as 'auto' })}><option value="auto">{t('touchAuto')}</option><option value="on">{t('touchOn')}</option><option value="off">{t('touchOff')}</option></select></td></tr>
